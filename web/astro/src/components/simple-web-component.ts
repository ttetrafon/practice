const componentName: string = "simple-web-component";
...
class Component extends HTMLElement {
  ...
  set data(value: string | null) {
    if (value != null && value != undefined) this.setAttribute('data', value);
  }
  set label(value: string | null) {
    if (value != null && value != undefined) this.setAttribute('label', value);
  }
