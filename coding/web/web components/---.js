...
class Component extends HTMLElement {
  constructor() {
    ...
    this.$div = this._shadow.getElementById("an-id");
  }

  // We create and use custom attributes with `.hasAttribute("attr")`, `.getAttribute("attr")`, `.setAttribute("attr")`, and `.removeAttribute("attr")`.
  // Note that custom attributes, like normal ones, have case-insensitive names and their values are always strings.
