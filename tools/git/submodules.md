...
- Sometimes gitmodules can be requested over `https://` instead of `git@`.
- To keep using the key when using the submodules, add a global rule to convert https to git.
